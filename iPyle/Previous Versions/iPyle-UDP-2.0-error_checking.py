...
def iPyleServer(HOST):
    ...
    client_dirs, client_addr = recv_from(s)
    ...
    client_files, client_addr = recv_from(s)
    ...
    if to_add_server_files:
        for f in to_add_server_files:
            recv_file, client_addr = recv_from(s)
    ...
    try:
        while (True):
            ...
            client_after_dirs, client_addr = recv_from(s)
        
            client_after_dirs = pickle.loads(client_after_dirs)

            server_after_files = list_files()     
            client_after_files, client_addr = recv_from(s)
            ...
            client_before_dirs, client_addr = recv_from(s)
        
            client_before_dirs = pickle.loads(client_before_dirs)
            client_before_files, client_addr = recv_from(s)
...
def iPyleClient(HOST):
    ...
    to_add_client_dirs, server_addr = recv_from(s)
    ...
    to_add_server_files, server_addr = recv_from(s)
    ...
    to_add_client_files, server_addr = recv_from(s)
    
    to_add_client_files = pickle.loads(to_add_client_files)
    if to_add_client_files:
        for f in to_add_client_files:
            recv_file, server_addr = recv_from(s)
    ...
    try:
        while (True):
            ...
            server_additions_dirs, server_addr = recv_from(s)
            ...
            client_additions_files, server_addr = recv_from(s)
            ...
            server_additions_files, server_addr = recv_from(s)
            ...
            # Process Removals
            server_removals_files, server_addr = recv_from(s)
            ...
            server_removals_dirs, server_addr = recv_from(s)
